        ...
        querySnapshot.forEach(function(doc) {
            ...
            newItem += `<span class="actual">${combo.price}</span><br>
							<ul class="buttons">								
								...
								<li id="${combo.category}_${doc.id}_id_buy}" class="cart btn"><a href="javascript:addToCart('${doc.id}','${combo.name}','${combo.description}','${imgUrl}','${combo.price}','${combo.category}',1)">Comprar</a></li>
                                <div class="clear"> </div>
							</ul>
                            </div>
                            </a>
